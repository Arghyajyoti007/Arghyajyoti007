...
- 📊 **Business Intelligence:** Developed 5+ interactive Power BI dashboards tracking 15+ KPIs, improving reporting efficiency by **40%**.
- 🛠️ **Data Wrangling:** Processed and cleaned datasets exceeding **500k+ rows** using Python (Pandas/NumPy), improving data accuracy by **30%**.
- 🔍 **Advanced Querying:** Engineered complex SQL queries (CTEs, Window Functions) to extract insights from **1M+ enterprise records**.
- 🏆 **Recognition:** Awarded the **HCL Excellence Award (2025)** for contributions to SAP Access & License Management analytics.
